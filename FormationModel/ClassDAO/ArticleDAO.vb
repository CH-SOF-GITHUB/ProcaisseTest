...
#Region "Database Field Map"
    ...
    Private _ART_MargeB As String = ""

    <XmlElementAttribute("ART_MargeB")>
    Public Property ART_MargeB() As String
        Get
            Return _ART_MargeB
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_TVA As String = ""

    <XmlElementAttribute("ART_TVA")>
    Public Property ART_TVA() As String
        Get
            Return _ART_TVA
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_Fodec As String = ""

    <XmlElementAttribute("ART_Fodec")>
    Public Property ART_Fodec() As String
        Get
            Return _ART_Fodec
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_DC As String = ""

    <XmlElementAttribute("ART_DC")>
    Public Property ART_DC() As String
        Get
            Return _ART_DC
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_Image As Boolean = False

    <XmlElementAttribute("ART_Image")>
    Public Property ART_Image() As Boolean
        Get
            Return _ART_Image
        End Get
    ...
    Private _ART_NumSerie As Integer = 0

    <XmlElementAttribute("ART_NumSerie")>
    Public Property ART_NumSerie() As Integer
        Get
    ...
    Private _ART_IsTaktile As String = ""

    <XmlElementAttribute("ART_IsTaktile")>
    Public Property ART_IsTaktile() As String
        Get
    ...
    Private _ART_export As String = ""

    <XmlElementAttribute("ART_export")>
    Public Property ART_export() As String
        Get
            Return _ART_export
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_ddm As String = ""

    <XmlElementAttribute("ART_ddm")>
    Public Property ART_ddm() As String
        Get
            Return _ART_ddm
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_Cout_charge As String = ""

    <XmlElementAttribute("ART_Cout_charge")>
    Public Property ART_Cout_charge() As String
        Get
    ...
    Private _ART_codeSerie As Integer = 0

    <XmlElementAttribute("ART_codeSerie")>
    Public Property ART_codeSerie() As Integer
        Get
    ...
    Private _CRPonderer As String = ""

    <XmlElementAttribute("CRPonderer")>
    Public Property CRPonderer() As String
        Get
            Return _CRPonderer
        End Get
        Set(ByVal value As String)
    ...
    Private _Coeff_charge As Integer = 0

    <XmlElementAttribute("Coeff_charge")>
    Public Property Coeff_charge() As Integer
        Get
    ...
    Private _Charge_tot_coeff As String = ""

    <XmlElementAttribute("Charge_tot_coeff")>
    Public Property Charge_tot_coeff() As String
        Get
    ...
    Private _is_bloquer As String = ""

    <XmlElementAttribute("is_bloquer")>
    Public Property is_bloquer() As String
        Get
            Return _is_bloquer
        End Get
        Set(ByVal value As String)
    ...
    Private _ART_CodeFrs As Integer = 0

    <XmlElementAttribute("ART_CodeFrs")>
    Public Property ART_CodeFrs() As Integer
        Get
            Return _ART_CodeFrs
        End Get
        Set(ByVal value As Integer)
    ...
    Private _ART_Poid_Qte As Decimal = Nothing

    <XmlElementAttribute("ART_Poid_Qte")>
    Public Property ART_Poid_Qte() As Decimal
        Get
    ...
    Private _Emp_Code As Integer = 0
    ...
    Private _Anc_cout As String = ""

    <XmlElementAttribute("Anc_cout")>
    Public Property Anc_cout() As String
        Get
            Return _Anc_cout
        End Get
        Set(ByVal value As String)
    ...
    Private _Art_Session As String = ""

    <XmlElementAttribute("Art_Session")>
    Public Property Art_Session() As String
        Get
            Return _Art_Session
        End Get
        Set(ByVal value As String)
    ...
    Private _Art_Prom As String = ""

    <XmlElementAttribute("Art_Prom")>
    Public Property Art_Prom() As String
        Get
            Return _Art_Prom
        End Get
        Set(ByVal value As String)
    ...
    Private _Art_NbProm As String = ""

    <XmlElementAttribute("Art_NbProm")>
    Public Property Art_NbProm() As String
        Get
            Return _Art_NbProm
        End Get
        Set(ByVal value As String)
    ...
    Private _Remise_Fidelite As String = ""

    <XmlElementAttribute("Remise_Fidelite")>
    Public Property Remise_Fidelite() As String
        Get
...
Partial Public Class ArticleDAO
    ...
    Public Overrides Function Read(Id As String) As Article
        ...
        Try
            ...
            If myReader.HasRows Then
                If Not myReader("ART_Code") Is DBNull.Value Then
    ...
    Public Function Update(ByRef cls As Article) As Integer
        ...
        Try
            ...
            sql &= "ART_export = " & Ap(cls.ART_export) & ","
            ...
            sql &= "is_bloquer = " & Ap(cls.is_bloquer) & ","
            ...
            sql &= "Art_Session = " & Ap(cls.Art_Session) & ","
            sql &= "Art_Prom = " & Ap(cls.Art_Prom) & ","
    ...
    Public Overrides Function GetAll(Optional OrderByField As String = "", Optional ByVal AddEmptyItem As Boolean = False) As IEnumerable(Of Article)
        ...
        Try
            ...
            myCommand.CommandText = sql
            Dim myReader As SqlDataReader = myCommand.ExecuteReader()
            If AddEmptyItem Then Ls.Add(New Article() With {.ART_Code = "", .ART_Designation = "", .ART_PrixUnitaireHT = Nothing, .ART_CodeBar = "", .ART_DesgCourte = "", .ART_Famille = "", .ART_Marque = "", .ART_MargeB = "", .ART_PrixUnitaireHTVA = Nothing, .ART_TypePrixUnitaireHTVA = "", .ART_TVA = "", .ART_Couleur = "", .ART_User = "", .ART_Station = "", .ART_QTEmin = Nothing, .ART_Fodec = "", .ART_DC = "", .ART_QTEmax = Nothing, .ART_TAILLE = "", .ART_QteDeclaree = Nothing, .ART_Prix_AchatFactReel = Nothing, .ART_Image = False, .ART_DateCr = Nothing, .ART_QteStock = Nothing, .ART_NumSerie = 0, .ART_IsTaktile = "", .ART_PrixGros1 = Nothing, .ART_QtePrixGros1 = Nothing, .ART_PrixGros2 = Nothing, .ART_QtePrixGros2 = Nothing, .ART_PrixGros3 = Nothing, .ART_QteGros3 = Nothing, .ART_CoulBN = "", .ART_PrixUnitaireHTRes = Nothing, .ART_PrixUnitaireHTGlobale = Nothing, .ART_export = "", .ART_ddm = "", .PrixSolde = Nothing, .TauxSolde = Nothing, .ART_Equivalence = "", .Regularisation = "", .ART_Cout_charge = "", .ART_codeSerie = 0, .CRPonderer = "", .QTE_Restante = Nothing, .Coeff_charge = 0, .Charge_tot_coeff = "", .Type_Produit = "", .Type_service = "", .is_bloquer = "", .ART_CodeFrs = 0, .ART_Fournisseur = "", .ART_Poid_Qte = Nothing, .Emp_Code = 0, .Touche_Balance = "", .Anc_cout = "", .Art_Session = "", .Art_Prom = "", .Art_NbProm = "", .Art_TauxProm = Nothing, .Remise_Fidelite = "", .ddm = ""})
            While myReader.Read
                Dim classe As New Article
                If Not myReader("ART_Code") Is DBNull.Value Then classe.ART_Code = myReader("ART_Code")
                If Not myReader("ART_Designation") Is DBNull.Value Then classe.ART_Designation = myReader("ART_Designation")
