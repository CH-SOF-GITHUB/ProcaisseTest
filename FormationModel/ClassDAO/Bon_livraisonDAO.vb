    ...
    Public Overrides Function Read(Id As String) As Bon_livraison
        ...
        Try
            ...
            If myReader.HasRows Then
                ...
                If Not myReader("BON_LIV_Date") Is DBNull.Value Then
                    cls.BON_LIV_Date = myReader("BON_LIV_Date")
                End If
                If Not myReader("BON_LIV_CodeClient") Is DBNull.Value Then
                    cls.BON_LIV_CodeClient = myReader("BON_LIV_CodeClient")
                End If
                If Not myReader("BON_LIV_StationOrigine") Is DBNull.Value Then
