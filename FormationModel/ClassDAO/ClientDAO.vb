...
#Region "Database Field Map"
    ...
    Private _avec_qui_convention As String = ""

    <XmlElementAttribute("avec_qui_convention")>
    Public Property avec_qui_convention() As String
        Get
            Return _avec_qui_convention
        End Get
        Set(ByVal value As String)
            _avec_qui_convention = value
        End Set
    End Property
#End Region
...
Partial Public Class ClientDAO
    ...
    Public Overrides Function Read(Id As String) As Client
        ...
        Try
            ...
            If myReader.HasRows Then
                ...
                End If
                If Not myReader("avec_qui_convention") Is DBNull.Value Then
                    cls.avec_qui_convention = myReader("avec_qui_convention")
                End If
            End If
            myReader.Close()
            myCommand.Dispose()
    ...
    Public Overrides Function Save(ByRef cls As Client) As Integer
        ...
        Try
            ...
            sql &= Ap(cls.Clt_CIN) & ","
            sql &= Ap(cls.avec_qui_convention)
            sql &= ")"
    ...
    Public Function Update(ByRef cls As Client) As Integer
        ...
        Try
            ...
            sql &= "avec_qui_convention = " & Ap(cls.avec_qui_convention)
    ...
    Private Function FindReal(ByVal OrderBy As String, ByVal ParamArray Parameter() As LUNA.LunaSearchParameter) As IEnumerable(Of Client)
        ...
        Try
            ...
            While myReader.Read
                ...
                If Not myReader("avec_qui_convention") Is DBNull.Value Then classe.avec_qui_convention = myReader("avec_qui_convention")
                Ls.Add(classe)
            End While
            myReader.Close()
            myCommand.Dispose()
